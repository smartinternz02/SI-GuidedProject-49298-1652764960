...
API_KEY = "UoONOA3v5bJkranlPkbW2jyrO8IhUpzafOviD1hc7AQg"
...
#payload_scoring = {"input_data": [{"fields": [array_of_input_fields], "values": [array_of_values_to_be_scored, another_array_of_values_to_be_scored]}]}
  ...
  response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/2fc12f58-ef31-48b0-a996-b6a4b33ae6a2/predictions?version=2022-06-02', json=payload_scoring,
